        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="{{ $message->embed(public_path() . '/images/photo_profil.jpg') }}" height="75" alt="alt_text" border="0" style="height: 20px; background: #dddddd;  font-size: 20px; line-height: 140%; color: #ffffff; border-radius: 50%;"/>
                    <a href="http://dimitrisandron.fr" style="color: #ffffff !important; font-family: sans-serif; font-weight: normal;"><strong>Portfolio</strong> Dimitri Sandron</a>
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                                    <tr>
                                        <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                            <a href="http://dimitrisandron.fr/login" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px; font-family: sans-serif; color: #888888; font-size: 12px; line-height: 140%;">
            <tr>
                <td style="padding: 40px 10px; width: 100%; font-family: sans-serif; font-size: 12px; line-height: 140%; text-align: center; color: #888888;" class="x-gmail-data-detectors">
                    ...
                    <br><br>
                    Dimitri Sandron<br>dimitri.sandron@outlook.fr<br>00.00.00.00.00
                    <br><br>
