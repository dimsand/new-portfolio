...
@section('content')
    ...
    <div class="grid">
        <form action="{{ route('password.request') }}" method="POST" class="form login">
            {{ csrf_field() }}
            ...
            <div class="form__field">
                <label for="login__password_confirmation">
                    ...
                    <span class="hidden">Password</span></label>
                <input id="login__password_confirmation" type="password" name="password_confirmation" class="form__input" placeholder="Confirm password"
                       required>
            </div>
